-- Incremental migrations for Virtual Wardrobe enhancements
...
-- 2. Active sessions table for session management
...
-- 8. Enhance clothes table with advanced attributes
ALTER TABLE clothes 
...
-- Add indexes for new clothes columns
ALTER TABLE clothes ADD INDEX IF NOT EXISTS idx_season (season);
ALTER TABLE clothes ADD INDEX IF NOT EXISTS idx_brand (brand);
ALTER TABLE clothes ADD INDEX IF NOT EXISTS idx_color (color);

-- 9. Outfit wear tracking table
